...
const addTransaction = async (id, new_stock, type, quantity) => {
  ...
  try {
    ...
    const query = `
    INSERT INTO Transactions (product_id, transaction_type, quantity, transaction_date, balance_stock)
    VALUES ($1, $2, $3, $4, $5)
    RETURNING transaction_type, quantity;
    `;
    const values = [id, type, quantity, currentDate, new_stock]; // Ensure this array has exactly 5 elements
